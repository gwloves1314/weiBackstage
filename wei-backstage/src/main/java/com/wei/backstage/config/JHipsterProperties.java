...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "weiBackstage@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "weiBackstage API";

        private String description = "weiBackstage API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "weiBackstage";
